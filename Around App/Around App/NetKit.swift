...
class NetKit: HTTPLayerDelegate {
    ...
    func request(type: HTTPMethod, url: String?=nil, data: AnyObject? = nil, headers: [String:String]?=nil, completionHandler: CompletionHandler? = nil, errorHandler: ErrorHandler? = nil,progress: Progress? = nil) {
        ...
        switch type {
        case .POST:
            self.post(data, url:url, headers:headers, completionHandler: completionHandler, errorHandler: errorHandler, progress: progress)
            break
        case .PUT:
            self.put(data, url:url, headers:headers, completionHandler: completionHandler, errorHandler: errorHandler, progress: progress)
            break
        case .GET:
            self.get(url, headers:headers, completionHandler: completionHandler, errorHandler: errorHandler, progress: progress)
            break
        case .DELETE:
            self.delete(url, headers:headers, completionHandler: completionHandler, errorHandler: errorHandler, progress: progress)
            break
        }
    }
    ...
    func put(data: AnyObject? = nil, url: String?=nil, headers: [String:String]?=nil, completionHandler: CompletionHandler? = nil, errorHandler: ErrorHandler? = nil,progress: Progress? = nil) {
        ...
        if let request = self.generateURLRequest(fullURL, method: HTTPMethod.POST) {
            ...
            let httpLayer = HTTPLayer(completionHandler, errorHandler, progress)
    ...
    func post(data: AnyObject? = nil, url: String?=nil, headers: [String:String]?=nil, completionHandler: CompletionHandler? = nil, errorHandler: ErrorHandler? = nil,progress: Progress? = nil) { //contentType, postData
        ...
        if let request = self.generateURLRequest(fullURL, method: HTTPMethod.POST) {
                if let json = data! as? JSON {
                    ...
                    let text = json.toString(true) as String
                    print("BODY=\(text)")
    ...
    private func setContentType(request: NSMutableURLRequest, _ type: NKContentType) {
        print("Set content type: \(type.rawValue)")
...
extension JSON {
    ...
    public convenience init(nsurl:NSURL) {
        ...
        var err:NSError?
        do {
            let str = try NSString(contentsOfURL: nsurl, encoding: enc)
